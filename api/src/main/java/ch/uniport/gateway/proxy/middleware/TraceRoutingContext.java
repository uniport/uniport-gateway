...
/**
 * Wraps a {@link RoutingContext} and simply delegate all method calls to the
 * wrapped handler
 * See:
 * https://github.com/vert-x3/vertx-web/blob/4.5.18/vertx-web/src/main/java/io/vertx/ext/web/impl/RoutingContextInternal.java
 * 
