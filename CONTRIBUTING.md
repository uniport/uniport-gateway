...
- **Use the repo's default branch.** Branch from and [submit your pull request](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request-from-a-fork) to the repo's default branch. Usually this is `main` or `master`.
...
8. If applicable, prefix the title with the relevant issue number. (examples: "PORTAL-123: Fix typo", "#42: Fix missing avatar")

```
[Issue] Short summary of changes in 50 chars or less
...
To confirm that you have read this guide and are following it as best as possible, **include this emoji at the top** of your issue or pull request: :rainbow: `:rainbow:`
