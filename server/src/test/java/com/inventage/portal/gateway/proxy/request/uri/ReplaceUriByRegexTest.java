...
public class ReplaceUriByRegexTest {

    @Test
    public void test_starting_with() {
        // given
        final ReplaceUriByRegex r = new ReplaceUriByRegex("^/organisation/*", "/");
        // when
    ...
    public void test_exact() {
        // given
        final ReplaceUriByRegex r = new ReplaceUriByRegex("^/status*.*", "/status/200");
        // when
