...
public class ParserTest {
  ...
  static Stream<Arguments> filterKeysTestData() {
    ...
    return Stream.of(Arguments.of("labels is null", null, null, List.of()),
        ...
        Arguments.of("identity is returned if filter is empty", labels, List.of(), new ArrayList<>(labels.keySet())),
  ...
  void filterKeysTest(String name, Map<String, Object> labels, List<String> filters, List<String> expected, Vertx vertx,
  ...
  void decodeTest(String name, Map<String, Object> labels, String rootName, JsonObject expected, Vertx vertx,
    ...
    String errMsg = String.format("'%s' failed. Labels: '%s', RootName: '%s', Filters: '%s'", name, labels, rootName,
        filters);
