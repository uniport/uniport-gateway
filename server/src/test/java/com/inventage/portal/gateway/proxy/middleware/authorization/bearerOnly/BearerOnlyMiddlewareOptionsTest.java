...
public class BearerOnlyMiddlewareOptionsTest {
    ...
    public void shouldParse() {
        ...
        final JsonObject json = JsonObject.of(
            ...
            BearerOnlyMiddlewareFactory.BEARER_ONLY_OPTIONAL, optional);

        // when
        final ThrowingSupplier<BearerOnlyMiddlewareOptions> parse = () -> codec.readValue(json.encode(), BearerOnlyMiddlewareOptions.class);

        // then
        final BearerOnlyMiddlewareOptions options = assertDoesNotThrow(parse);
        ...
        assertEquals(optional, options.isOptional());
    }
}
