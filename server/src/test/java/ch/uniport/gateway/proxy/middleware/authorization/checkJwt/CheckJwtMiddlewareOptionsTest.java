...
public class CheckJwtMiddlewareOptionsTest {
    ...
    public void shouldParse() {
        ...
        // when
        final ThrowingSupplier<CheckJWTMiddlewareOptions> parse = () -> new ObjectMapper().readValue(json.encode(), CheckJWTMiddlewareOptions.class);

        // then
        final CheckJWTMiddlewareOptions options = assertDoesNotThrow(parse);
