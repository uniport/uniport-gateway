...
import static ch.uniport.gateway.proxy.middleware.oauth2.AbstractOAuth2MiddlewareOptionsBase.DEFAULT_OIDC_RESPONSE_MODE;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2AuthMiddleware.OIDC_PARAM_STATE;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2AuthMiddlewareTest.CODE_CHALLENGE;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2AuthMiddlewareTest.CODE_CHALLENGE_METHOD;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2AuthMiddlewareTest.PKCE_METHOD_PLAIN;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2AuthMiddlewareTest.PKCE_METHOD_S256;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2AuthMiddlewareTest.SCOPE;
import static ch.uniport.gateway.proxy.middleware.oauth2.OAuth2MiddlewareFactory.OIDC_RESPONSE_MODE;
