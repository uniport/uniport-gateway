...
public abstract class AbstractSessionMiddlewareOptions implements MiddlewareOptionsModel {
    ...
    public static final boolean DEFAULT_SESSION_LIFETIME_COOKIE_HTTP_ONLY = false; // false := cookie must be accessible
                                                                                   // by client side scripts
    public static final boolean DEFAULT_SESSION_LIFETIME_COOKIE_SECURE = false;
    public static final CookieSameSite DEFAULT_SESSION_LIFETIME_COOKIE_SAME_SITE = CookieSameSite.STRICT; // prevent
                                                                                                          // warnings in
                                                                                                          // Firefox
                                                                                                          // console
    ...
    public int getIdleTimeoutMinutes() {
        logDefault(LOGGER, SessionMiddlewareFactory.SESSION_IDLE_TIMEOUT_IN_MINUTES,
    ...
    public String getIgnoreSessionTimeoutResetForURI() {
        logDefault(LOGGER, SessionMiddlewareFactory.IGNORE_SESSION_TIMEOUT_RESET_FOR_URI,
            DEFAULT_IGNORE_SESSION_TIMEOUT_RESET_FOR_URI);
    ...
    public Integer getClusteredSessionStoreRetryTimeoutMs() {
        logDefault(LOGGER, SessionMiddlewareFactory.CLUSTERED_SESSION_STORE_RETRY_TIMEOUT_MS,
