...
public class SessionAdapter {
    ...
    public static String displaySessionId(RoutingContext context) {
        final Cookie sessionCookie = context.request()
            .getCookie(AbstractSessionMiddlewareOptions.DEFAULT_SESSION_COOKIE_NAME);
        return sessionCookie == null ? EMPTY_SESSION_DISPLAY
            : firstCharactersOf(SESSION_ID_DISPLAYED_LENGTH, sessionCookie.getValue());
    }
