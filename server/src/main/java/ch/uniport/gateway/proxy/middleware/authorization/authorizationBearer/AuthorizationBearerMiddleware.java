 ...
 * either an ID token or
 * an access token as defined in the sessionScope. Access tokens are only
 * provided if the
 * sessionScope matches the corresponding scope of the OAuth2 provider. It also
 * ensures that no
