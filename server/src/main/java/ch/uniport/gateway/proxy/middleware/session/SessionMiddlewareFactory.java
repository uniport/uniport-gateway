...
public class SessionMiddlewareFactory implements MiddlewareFactory {
    ...
    public ObjectSchemaBuilder optionsSchema() {
        return Schemas.objectSchema()
            ...
            .optionalProperty(SESSION_COOKIE, Schemas.objectSchema()
                ...
                .optionalProperty(SESSION_COOKIE_SAME_SITE,
                    Schemas.enumSchema((Object[]) COOKIE_SAME_SITE_POLICIES)
                        .defaultValue(
                            AbstractSessionMiddlewareOptions.DEFAULT_SESSION_COOKIE_SAME_SITE))
    ...
    public Future<Void> validate(JsonObject options) {
        if (options.containsKey(SESSION_COOKIE) &&
            ...
            !CookieUtil.isValidCookieName(LOGGER,
                options.getJsonObject(SESSION_COOKIE).getString(SESSION_COOKIE_NAME))) {
