package ch.uniport.gateway.core;
...
import ch.uniport.gateway.core.config.env.ConfigAdapter;
import ch.uniport.gateway.core.config.file.GatewayConfigRetriever;
...
import ch.uniport.gateway.proxy.listener.RouterSwitchListener;
import ch.uniport.gateway.proxy.provider.aggregator.ProviderAggregator;
...
public class GatewayVerticle extends AbstractVerticle {
    ...
    private Future<Entrypoint> createEntrypoint(
        ...
        // * the top level router containing the entrypoint middlewares created by the
        // Entrypoint
        // * the bottom level router containing the router middlewares created by the
        // RouterFactory
        // * and the mid level router glueing the top and the bottom level router
        // together that can be cleared on a dynamic configuration change without
        // affecting the top level router
