...
public abstract class AbstractReplacedSessionCookieDetectionMiddlewareOptions implements MiddlewareOptionsModel {
    ...
    public String getCookieName() {
        logDefault(LOGGER, ReplacedSessionCookieDetectionMiddlewareFactory.DETECTION_COOKIE_NAME, DEFAULT_DETECTION_COOKIE_NAME);
    ...
    public String getSessionCookieName() {
        logDefault(LOGGER, ReplacedSessionCookieDetectionMiddlewareFactory.SESSION_COOKIE_NAME, DEFAULT_SESSION_COOKIE_NAME);
    ...
    public int getWaitBeforeRetryMs() {
        logDefault(LOGGER, ReplacedSessionCookieDetectionMiddlewareFactory.WAIT_BEFORE_RETRY_MS, DEFAULT_WAIT_BEFORE_RETRY_MS);
    ...
    public int getMaxRetries() {
        logDefault(LOGGER, ReplacedSessionCookieDetectionMiddlewareFactory.MAX_REDIRECT_RETRIES, DEFAULT_MAX_REDIRECT_RETRIES);
