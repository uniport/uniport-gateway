...
public interface UriMiddlewareProvider {
    ...
    class Loader {
        public static UriMiddlewareProvider getProvider(String providerId) {
            final Optional<UriMiddlewareProvider> provider = ServiceLoader.load(UriMiddlewareProvider.class).stream()
            ...
            if (provider.isPresent()) {
                ...
                throw new IllegalStateException(String.format("Uri middleware provider '%s' doesn't exist!", providerId));
            }
        }
    }
