...
public class DockerContainerProviderFactory implements ProviderFactory {
        ...
        public Provider create(Vertx vertx, String configurationAddress, JsonObject providerConfig,
                ...
                Boolean exposedByDefault = providerConfig.getBoolean(
                                StaticConfiguration.PROVIDER_DOCKER_EXPOSED_BY_DEFAULT, true);
                String network = providerConfig
                                .getString(StaticConfiguration.PROVIDER_DOCKER_NETWORK, "");
                String defaultRule = providerConfig.getString(
