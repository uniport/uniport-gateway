...
public class PortalGatewayLauncher extends Launcher {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("vertx.metrics.options.registryName", "PortalGatewayMetrics"); // name of the metrics registry
        ...
        final String[] arguments = new String[]{"run", PortalGatewayVerticle.class.getName(), "--instances", Runtime.numberOfVerticleInstances()};
