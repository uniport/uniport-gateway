...
public abstract class AbstractLanguageCookieMiddlewareOptions implements GatewayMiddlewareOptions {
    ...
    @Default
    @JsonProperty(LanguageCookieMiddlewareFactory.NAME)
    public String getCookieName() {
        logDefault(LOGGER, LanguageCookieMiddlewareFactory.NAME, LanguageCookieMiddlewareFactory.DEFAULT_LANGUAGE_COOKIE_NAME);
