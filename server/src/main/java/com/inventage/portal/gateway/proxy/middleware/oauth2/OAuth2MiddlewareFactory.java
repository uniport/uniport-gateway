...
public class OAuth2MiddlewareFactory implements MiddlewareFactory {
    ...
    public Future<Middleware> create(Vertx vertx, Router router, JsonObject middlewareConfig) {
        ...
        final String name = middlewareConfig.getString(RouterFactory.MIDDLEWARE_INSTANCE_NAME);
        ...
        keycloakDiscoveryFuture.onSuccess(authProvider -> {
            ...
            result.complete(new OAuth2AuthMiddleware(authHandler, sessionScope, name));
