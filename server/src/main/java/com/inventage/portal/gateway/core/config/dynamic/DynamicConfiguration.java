...
public class DynamicConfiguration {
        ...
        private static Schema buildSchema(Vertx vertx) {
                ObjectSchemaBuilder routerSchema = Schemas.objectSchema()
                                ...
                                .requiredProperty(ROUTER_ENTRYPOINTS,
                                                Schemas.arraySchema().items(Schemas.stringSchema()))
                ...
                ObjectSchemaBuilder serviceSchema = Schemas.objectSchema()
                                ...
                                .requiredProperty(SERVICE_SERVERS, Schemas.arraySchema().items(Schemas.objectSchema()
                                                .requiredProperty(SERVICE_SERVER_SCHEMA, Schemas.stringSchema())
