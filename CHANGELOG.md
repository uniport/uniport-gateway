...
- Flaky test `SessionMiddlewareTest.noResetRequestDoesNotAccessCookie`: the test browser does not persist cookies, so each request created a fresh session and the test compared two wall-clock based lifetime values, failing whenever the requests straddled a second boundary. The test now replays the session cookie, so the ignored requests hit the same session, and additionally asserts that `lastAccessed` (millisecond precision) is not modified.
...
- Support for dynamically loading custom middlewares provided via an additional JAR ([PORTAL-2512](https://inventage-all.atlassian.net/browse/PORTAL-2512)).
- Upgrade chart library to version 6.3.0 to support annotations ([PORTAL-2577](https://inventage-all.atlassian.net/browse/PORTAL-2577)).
...
[unreleased]: https://github.com/uniport/uniport-gateway/compare/10.4.0...main
[10.4.0]: https://github.com/uniport/uniport-gateway/compare/10.3.0...10.4.0
...
[9.2.0]: https://github.com/uniport/uniport-gateway/compare/9.1.0...9.2.0
[9.1.0]: https://github.com/uniport/uniport-gateway/compare/9.0.0...9.1.0
[9.0.0]: https://github.com/uniport/uniport-gateway/compare/8.3.0...9.0.0
[8.3.0]: https://github.com/uniport/uniport-gateway/compare/8.2.0...8.3.0
[8.2.0]: https://github.com/uniport/uniport-gateway/compare/8.1.0...8.2.0
[8.1.0]: https://github.com/uniport/uniport-gateway/compare/8.0.0...8.1.0
[8.0.0]: https://github.com/uniport/uniport-gateway/compare/7.0.2...8.0.0
[7.0.2]: https://github.com/uniport/uniport-gateway/compare/7.0.1...7.0.2
[7.0.1]: https://github.com/uniport/uniport-gateway/compare/7.0.0...7.0.1
[7.0.0]: https://github.com/uniport/uniport-gateway/compare/6.0.0...7.0.0
[6.0.0]: https://github.com/uniport/uniport-gateway/compare/5.1.0...6.0.0
[5.1.0]: https://github.com/uniport/uniport-gateway/compare/5.0.0...5.1.0
[5.0.0]: https://github.com/uniport/uniport-gateway/compare/4.3.0...5.0.0
[4.3.0]: https://github.com/uniport/uniport-gateway/compare/4.2.0...4.3.0
[4.2.0]: https://github.com/uniport/uniport-gateway/compare/4.1.0...4.2.0
[4.1.0]: https://github.com/uniport/uniport-gateway/compare/4.0.0...4.1.0
[4.0.0]: https://github.com/uniport/uniport-gateway/compare/3.3.0...4.0.0
[3.3.0]: https://github.com/uniport/uniport-gateway/compare/3.2.0...3.3.0
[3.2.0]: https://github.com/uniport/uniport-gateway/compare/3.1.0...3.2.0
[3.1.0]: https://github.com/uniport/uniport-gateway/compare/3.0.0...3.1.0
[3.0.0]: https://github.com/uniport/uniport-gateway/compare/2.7.0...3.0.0
[2.7.0]: https://github.com/uniport/uniport-gateway/compare/2.6.0...2.7.0
[2.6.0]: https://github.com/uniport/uniport-gateway/compare/2.5.0...2.6.0
[2.5.0]: https://github.com/uniport/uniport-gateway/compare/2.4.1...2.5.0
[2.4.1]: https://github.com/uniport/uniport-gateway/compare/2.3.0...2.4.1
[2.4.0]: https://github.com/uniport/uniport-gateway/compare/2.3.0...2.4.1
[2.3.0]: https://github.com/uniport/uniport-gateway/compare/2.2.0...2.3.0
[2.2.0]: https://github.com/uniport/uniport-gateway/compare/2.1.0...2.2.0
[2.1.0]: https://github.com/uniport/uniport-gateway/compare/2.0.0...2.1.0
[2.0.0]: https://github.com/uniport/uniport-gateway/compare/1.3.0...2.0.0
[1.3.0]: https://github.com/uniport/uniport-gateway/compare/1.2.0...1.3.0
[1.2.0]: https://github.com/uniport/uniport-gateway/compare/1.1.0...1.2.0
[1.1.0]: https://github.com/uniport/uniport-gateway/compare/1.0.0...1.1.0
[1.0.0]: https://github.com/uniport/uniport-gateway/compare/49fb083d...1.0.0
